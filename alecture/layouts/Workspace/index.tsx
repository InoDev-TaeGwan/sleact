...
const WorkSpace:VFC = () => { //VFC는 children을 안쓰는 컴포넌트의 타입, FC는 children을 쓰는 컴포넌트의 타입
    ...
    const { data:userData, error, revalidate,mutate } = useSWR<IUser | false>('/api/users', fetcher,{ // 사용자 데이터 가져옴
    ...
    const {data: memberData} = useSWR<IUser[]>( // 워크스페이스 안에 있는 멤버 데이터 가져옴
